...
theme.notification_font = "source code pro 13"
theme.notification_bg = "#2e3440"
theme.notification_fg = "#eceff4"
theme.notification_border_width = 200
theme.notification_border_color = "#eceff4"
...
theme.titlebar_close_button_normal = "~/.config/awesome/titlebar/close.png"
theme.titlebar_close_button_focus  = "~/.config/awesome/titlebar/close.png"

theme.titlebar_minimize_button_normal = "~/.config/awesome/titlebar/minimize.png"
theme.titlebar_minimize_button_focus  = "~/.config/awesome/titlebar/minimize.png"
...
theme.titlebar_ontop_button_normal_active = "~/.config/awesome/titlebar/ontop_active.png"
theme.titlebar_ontop_button_focus_active  = "~/.config/awesome/titlebar/ontop_active.png"
...
theme.titlebar_maximized_button_normal_active = "~/.config/awesome/titlebar/maximized.png"
theme.titlebar_maximized_button_focus_active  = "~/.config/awesome/titlebar/maximized.png"
...
-- Generate Awesome icon:themes_path..
